...
$serverDll = "$PSScriptRoot\..\src\HanshinChat.Mcp.ElasticSearch.Skill\bin\Debug\net8.0\HanshinChat.Mcp.ElasticSearch.Skill.dll"
...
$psi.WorkingDirectory = (Resolve-Path "$PSScriptRoot\..\src\HanshinChat.Mcp.ElasticSearch.Skill\bin\Debug\net8.0").Path
