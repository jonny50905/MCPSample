...
public class ConversationTools
{
    ...
    [McpServerTool(Name = "list_conversations"), Description("List conversations.")]
    ...
    [McpServerTool(Name = "get_conversation"), Description("Get conversation by Id (expands messages by default).")]
