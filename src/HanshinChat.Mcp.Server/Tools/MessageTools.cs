...
public class MessageTools
{
    ...
    [McpServerTool(Name = "list_messages"), Description(
        "List chat messages. Supports filter by conversation, sender type, intent, and (deleted) flag.")]
    ...
    [McpServerTool(Name = "search_messages"), Description(
        "Full-text search messages by substring in their ContentJson.")]
    ...
    [McpServerTool(Name = "get_message"), Description("Get a single message by Id (Guid).")]
