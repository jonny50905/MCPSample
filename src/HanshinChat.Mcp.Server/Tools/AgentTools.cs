...
public class AgentTools
{
    ...
    [McpServerTool(Name = "list_agents"), Description(
        "List customer-service agents from HanshinChat.")]
    ...
    [McpServerTool(Name = "get_agent"), Description("Get a single agent by Id (Guid).")]
